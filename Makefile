...
build-js:
	@$(NPM) install -g tern eslint babel-eslint eslint-plugin-react eslint-config-airbnb js-beautify jsonlint

build-ruby:
	@$(GEM) install pry

haskell:
	cabal install stylish-haskell hlint hasktags ghc-mod hindent
